...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Ты сосёш!', 0.2], //From 0% to 19%
		['Дерьмо', 0.4], //From 20% to 39%
		['Мда...', 0.5], //From 40% to 49%
		['Фу', 0.6], //From 50% to 59%
		['Не оч', 0.69], //From 60% to 68%
		['Найс', 0.7], //69%
		['Хорошо', 0.8], //From 70% to 79%
		['Очень хорошо', 0.9], //From 80% to 89%
		['Нифига себе!', 1], //From 90% to 99%
		['БЕЗУМИЕ!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "БОТ ПЛЕЙ", 32);
